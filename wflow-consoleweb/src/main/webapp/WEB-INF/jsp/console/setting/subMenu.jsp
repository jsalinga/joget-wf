...
<li id="nav-setting-wallet"><a class="nav-link" href="${pageContext.request.contextPath}/web/console/setting/wallet"><span class="nav-steps">&nbsp;</span><fmt:message key="console.header.submenu.label.setting.wallet"/></a></li>
