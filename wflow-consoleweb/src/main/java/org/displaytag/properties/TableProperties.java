...
/**
 * The properties used by the Table tags. The properties are loaded in the
 * following order, in increasing order of priority. The locale of getInstance()
 * is used to determine the locale of the property file to use; if the key
 * required does not exist in the specified file, the key will be loaded from a
 * more general property file.
 * <ol>
...
public final class TableProperties implements Cloneable {
     ...
     * property name is <code>export.</code>
     * <em>[export type]</em><code>.</code><em>[property name]</em>
     */
    public static final String PROPERTY_EXPORT_PREFIX = "export"; //$NON-NLS-1$

    /**
     * prefix used to set the media decorator property name. The full property
     * name is <code>decorator.media.</code>
     * <em>[export type]</em>.
     */
     ...
     * <code>decorator.media.</code>
     * <em>[export type]</em>
     */
    public static final String PROPERTY_DECORATOR_MEDIA = "media"; //$NON-NLS-1$

    /**
     * used to set the totaler property name. The property name is
     * <code>totaler</code>
     */
    ...
    /**
     * Property <code>pagination.sort.param</code>. If external pagination and
     * sorting is used, it holds the name of the parameter used to hold the sort
     * criterion in generated links
     */
    public static final String PROPERTY_STRING_PAGINATION_SORT_PARAM = "pagination.sort.param"; //$NON-NLS-1$

    /**
     * Property <code>pagination.sortdirection.param</code>. If external
     * pagination and sorting is used, it holds the name of the parameter used
     * to hold the sort direction in generated links (asc or desc)
     */
     ...
     * and sorting is used, it holds the name of the parameter used to hold the
     * page number in generated links
     */
     ...
     * and sorting is used, it holds the value of the parameter of the sort
     * direction parameter for "ascending"
     */
     ...
     * and sorting is used, it holds the value of the parameter of the sort
     * direction parameter for "descending"
     */
    public static final String PROPERTY_STRING_PAGINATION_DESC_VALUE = "pagination.sort.desc.value"; //$NON-NLS-1$

    /**
     * Property <code>pagination.sort.skippagenumber</code>. If external
     * pagination and sorting is used, it determines if the current page number
     * must be added in sort links or not. If this property is true, it means
     * that each click on a generated sort link will re-sort the list, and go
     * back to the default page number. If it is false, each click on a
     * generated sort link will re-sort the list, and ask the current page
     * number.
     */
    public static final String PROPERTY_BOOLEAN_PAGINATION_SKIP_PAGE_NUMBER_IN_SORT = "pagination.sort.skippagenumber"; //$NON-NLS-1$

    /**
     * Property <code>comparator.default</code>. If present, will use use as the
     * classname of the default comparator. Will be overriden by column level
     * comparators.
     */
    ...
    /**
     * Cache for dinamically instantiated object (request factory, decorator
     * factory).
     */
     ...
     * @throws TablePropertiesLoadException if default properties file can't be
     * found
     */
     ...
     * @throws TablePropertiesLoadException if the default
     * <code>TableTag.properties</code> file is not found.
     */
     ...
     * @throws TablePropertiesLoadException for errors during loading of
     * properties files
     */
     ...
     *
     * @param request HttpServletRequest needed to extract the locale to use. If
     ...
     *
     * @param ascending <code>true</code> if column is sorded in ascending
     * order.
     * @return the value of <code>PROPERTY_CSS_TH_SORTED_ASCENDING</code> if
     * column is sorded in ascending order or
     * <code>PROPERTY_CSS_TH_SORTED_DESCENDING</code> if column is sorded in
     * descending order.
     */
     ...
     * @throws FactoryInstantiationException if unable to load or instantiate
     * the configurated class.
     */
     ...
     *
     * @param key property name
     * @param defaultValue default value returned if property is not found or
