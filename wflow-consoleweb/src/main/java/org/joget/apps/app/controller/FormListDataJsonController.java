...
/**
 * Data JSON API to cater to the loading, storing and deletion of Form and List
 * data.
 */
@Controller
public class FormListDataJsonController {
    ...
    /**
     * Load a specific form record GET
     * /json/data/form/load/(*:appId)/(*:formId)/(*:primaryKeyValue) curl -v -X
     * POST -d "j_username=admin&j_password=admin"
    ...
    /**
     * Create or update a form record POST
     * /json/data/form/store/(*:appId)/(*:formId)/(*:primaryKeyValue) curl -v -X
     * POST -d
     * "j_username=admin&j_password=admin&accountName=001%Updated&address=001%20Address"
     * http://localhost:8080/jw/web/json/data/form/store/crm//crm_account/001
     * curl -v --header "Authorization: Basic YWRtaW46YWRtaW4=" -F
     * "accountName=001 Updated" -F "address=001 Address"
     * http://localhost:8080/jw/web/json/data/form/store/crm//crm_account/001
     *
     * @param writer
     * @param request
    ...
    /**
     * Delete an existing form record POST
     * /json/data/form/delete/(*:appId)/(*:formId)/(*:primaryKeyValue) curl -v
     * -X POST -d "j_username=admin&j_password=admin"
    ...
    /**
     * Retrieve records from a data list GET
     * /web/json/data/list/crm/crm_account_list curl -v -d
