...
/**
 * <p>
 * Helpers for <code>java.lang.System</code>.</p>
 *
 * <p>
 ...
 * message will be written to <code>System.err</code>.</p>
 *
...
public class SystemUtils {
    ...
    /**
     * <p>
     * The <code>awt.toolkit</code> System Property.</p>
     * <p>
     * Holds a class name, on Windows XP this is
     * <code>sun.awt.windows.WToolkit</code>.</p>
     * <p>
     * <b>On platforms without a GUI, this value is <code>null</code>.</b></p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     *
     * <p>
    ...
    /**
     * <p>
     * The <code>file.encoding</code> System Property.</p>
     * <p>
     * File encoding, such as <code>Cp1252</code>.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>java.awt.fonts</code> System Property.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>java.awt.graphicsenv</code> System Property.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>java.awt.printerjob</code> System Property.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>java.class.path</code> System Property. Java class path.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * use. First in JDK version 1.2. Not used in Sun JDKs after 1.2.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * search when loading libraries.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * Environment specification name.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * Environment specification vendor.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * Environment specification version.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>java.vendor.url</code> System Property. Java vendor URL.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>java.version</code> System Property. Java version number.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * Virtual Machine specification vendor.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * Virtual Machine specification version.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
     ...
     * <code>user.country</code> in 1.4</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>user.home</code> System Property. User's home directory.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * The <code>user.name</code> System Property. User's account name.</p>
     *
     * <p>
     * Defaults to <code>null</code> if the runtime does not have security
     * access to read this property or the property does not exist.</p>
    ...
    /**
     * <p>
     * Gets the Java version as a <code>float</code>.</p>
     *
     * <p>
    ...
    /**
     * <p>
     * Gets the Java version as an <code>int</code>.</p>
     *
     * <p>
     * Example return values:</p>
     * <ul>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is AIX.</p>
     *
     * <p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is HP-UX.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Irix.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Linux.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Mac.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is OS/2.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Solaris.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is SunOS.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
     ...
     * AIX, HP-UX, Irix, Linux, MacOSX, Solaris or SUN OS.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows 2000.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows 95.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows 98.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows ME.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows NT.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows XP.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows Vista.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Is <code>true</code> if this is Windows 7.</p>
     *
     * <p>
     * The field will return <code>false</code> if <code>OS_NAME</code> is
     * <code>null</code>.</p>
    ...
    /**
     * <p>
     * Gets the Java version number as a <code>float</code>.</p>
     *
     * <p>
     * Example return values:</p>
     * <ul>
     ...
     * {@link #JAVA_VERSION_TRIMMED} is <code>null</code>.</p>
     *
     * @return the version, for example 1.31f for JDK 1.3.1
     */
    ...
    /**
     * <p>
     * Gets the Java version number as an <code>int</code>.</p>
     *
     * <p>
     * Example return values:</p>
     * <ul>
    ...
    /**
     * <p>
     * Decides if the java version matches.</p>
     *
    ...
    /**
     * <p>
     * Decides if the operating system matches.</p>
     *
    ...
    /**
     * <p>
     * Is the Java version at least the requested version.</p>
     *
     * <p>
     * Example input:</p>
     * <ul>
    ...
    /**
     * <p>
     * Gets the Java home directory as a <code>File</code>.</p>
     *
     * @return a directory
    ...
    /**
     * <p>
     * Gets the Java IO temporary directory as a <code>File</code>.</p>
     *
     * @return a directory
     * @throws SecurityException if a security manager exists and its
     * <code>checkPropertyAccess</code> method doesn't allow access to the
    ...
    /**
     * <p>
     * Gets the user directory as a <code>File</code>.</p>
     *
     * @return a directory
     * @throws SecurityException if a security manager exists and its
     * <code>checkPropertyAccess</code> method doesn't allow access to the
    ...
    /**
     * <p>
     * Gets the user home directory as a <code>File</code>.</p>
     *
     * @return a directory
     * @throws SecurityException if a security manager exists and its
     * <code>checkPropertyAccess</code> method doesn't allow access to the
