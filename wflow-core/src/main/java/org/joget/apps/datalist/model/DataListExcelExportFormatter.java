...
public interface DataListExcelExportFormatter {
    ...
    /**
     * A flag to indicate excelBeforeRow method should be executed before each
     * row is generate in Excel
     *
     * @return
     */
    ...
    /**
     * A flag to indicate excelAfterRow method should be executed after each row
     * is generate in Excel
     *
     * @return
     */
