 ...
 * which implemented org.joget.apps.form.model.FormAjaxOptionsBinder to populate
 * its options using AJAX.
 *
 */
public interface FormAjaxOptionsElement extends FormOptionsElement {

    /**
     * Get dependent field element which use to control the options of this
     * field
     *
     * @param formData
     * @return
