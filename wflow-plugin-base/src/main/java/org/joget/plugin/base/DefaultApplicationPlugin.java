...
/**
 * A base abstract class to develop a Process Tool Plugin and Form Post
 * Submission Processing Plugin.
 *
 */
public abstract class DefaultApplicationPlugin extends ExtDefaultPlugin implements ApplicationPlugin, PropertyEditable {
     ...
     *
     * A org.joget.workflow.model.WorkflowAssignment object is passed as
     * "workflowAssignment" property when it is available.
     *
     * @param props
