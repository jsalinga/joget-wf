...
/**
 * Default panel for jawe object such as activity, route etc. It has icon and
 * name.
 *
...
public class DefaultCellPanel extends JPanel {
    ...
    /**
     * Set text and icon on panel depending on parameter place 1 - icon bottom,
     * text up 2 - icon top, text bottom 3 - icon right, text left default -
