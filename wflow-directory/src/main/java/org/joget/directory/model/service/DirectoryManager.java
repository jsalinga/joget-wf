...
public interface DirectoryManager {
    ...
    /**
     * Method called to retrieve a collection of Group in which a user belongs
     * to
     *
     * @param username
    ...
    /**
     * Generic method called to retrieve the entire Group listing within the
     * directory
     *
    ...
    /**
     * Method called to retrieve the entire Group listing within the directory
    ...
    /**
     * Generic method called to retrieve the entire User listing within the
     * directory
     *
     * @return Collection of User objects
     */
    ...
    /**
     * Method called to retrieve the entire User listing within the directory
     * filtered by search parameters
     *
     * @param nameFilter Filtering values to limit the listing
     * @param sort Field name to sort by
    ...
    /**
     * Method called to retrieve the Roles belonging to a specific User by
     * Username
     *
     * @param username
    ...
    /**
     * Method called to retrieve a listing of HODs in which a specific User
     * reports to
     *
     * @param username
    ...
    /**
     * Method called to retrieve a listing of Users which belongs to the same
     * Department as the specific Username
     *
     * @param username
     * @return Collection of Users
     */
    ...
    /**
     * Method called to retrieve a listing of Users which belongs to a specified
    ...
    /**
     * Method called to retrieve all Departments within the directory filtered
     * by search parameters
     *
     * @param sort Field name to sort by
     * @param desc Boolean value signifying if the sorting is in descending
     * order
