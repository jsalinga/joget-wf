...
/**
 * Extended interface of Directory Manager service to interact with Directory
 * Source
 *
 */
public interface ExtDirectoryManager extends DirectoryManager {
    ...
    /**
     * Method called to retrieve all groups within a specific Organization
    ...
    /**
     * Method call to retrieve the number of Groups available within a specific
     * Organization filtered by search parameters
     *
     * @param filterString
     * @param organizationId
     * @return
    ...
    /**
     * Method called to retrieve the users within the directory filtered by
     * search parameters
     *
     * @param filterString
     * @param organizationId
    ...
    /**
     * Method call to retrieve the number of Users available within the
     * directory filtered by search parameters
     *
     * @param filterString
     * @param organizationId
     * @param departmentId
    ...
    /**
     * Method called to retrieve a listing of all the subordinates which reports
     * to a specific User filtered by search parameters
     *
     * @param username
     * @param sort
     * @param desc
    ...
    /**
     * Method called to retrieve the number of subordinates which reports to a
     * specific User
     *
     * @param username
     * @return
    ...
    /**
     * Method called to retrieve the users' employment info within the directory
     * filtered by search parameters
     *
     * @param filterString
     * @param organizationId
    ...
    /**
     * Method called to retrieve the number of users' employment info within the
     * directory
     *
     * @param filterString
     * @param organizationId
    ...
    /**
     * Method called to retrieve a parent Department of a Department by
     * Department Name
     *
     * @param name
     * @return
    ...
    /**
     * Method called to retrieve all sub Departments within a specific
     * Department filtered by search parameters
     *
     * @param filterString
     * @param parentId
     * @param sort
    ...
    /**
     * Method called to retrieve the number of sub Departments within a specific
     * Department
     *
     * @param filterString
     * @param parentId
    ...
    /**
     * Method called to retrieve all Departments within a specific Organization
     * filtered by search parameters
     *
     * @param filterString
     * @param organizationId
    ...
    /**
     * Method called to retrieve the number of Departments within a specific
     * Organization filtered by search parameters
     *
     * @param filterString
     * @param organizationId
    ...
    /**
     * Method called to retrieve all Grades within a specific Organization
     * filtered by search parameters
     *
     * @param filterString
     * @param organizationId
    ...
    /**
     * Method called to retrieve the number of Grades within a specific
     * Organization filtered by search parameters
     *
     * @param filterString
     * @param organizationId
    ...
    /**
     * Method called to retrieve a collection of Group in/not in which a user
     * belongs to and filtered by search parameters
     *
     * @param filterString
     * @param userId
     * @param organizationId
    ...
    /**
     * Method called to retrieve the number of Group in/not in which a user
     * belongs to
     *
     * @param filterString
     * @param userId
