...
/**
 * Interface for user security enhancement. Used to extend the ability of
 * Directory Manager Plugin when managing local user directory
 */
public interface UserSecurity {

    /**
     * Get JSON property options to embed into the property options of Directory
     * Manager Plugin
     *
     * @param
